              ...
              <div className='md:columns-2 '>
                ...
                <div className='m-10 '></div>
                    ...
                    <div className="md:w-2/3 my-10">
                        ...
                        <div className="max-auto flex justify-center md:w-1/2 my-10">
                        <button className="bg-violet-800 text-white font-bold py-2 px-10 rounded-full" style={{background: '773F9F'}}>
                            Send 
                          </button>
                            </div>
